data remove storage ifsou:config showVersion
data remove storage ifsou:config version

scoreboard objectives remove IfsOU.Clac

data remove storage ifsou:recipe IfsA
